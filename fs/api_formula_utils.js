...
let FormulaUtils = {
    ...
    // ## **`FormulaUtils.computeAltitude(pressure, pressure_0)`**
    ...
    // ## **`FormulaUtils.initStatistics(samples)`**
    ...
    // ## **`FormulaUtils.addDataValue(statistics, value)`**
    ...
    // ## **`FormulaUtils.calculateStatistics(statistics)`**
