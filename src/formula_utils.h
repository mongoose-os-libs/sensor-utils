 ...
 * formula_utils
 *
 * Formula Utilities - A collection of C-functions that make it convenient to calculate derived quantities (e.g. dew point temperature),
 * convert between different units of measure, and perform simple statistics on arrays of (double precision)
 * values.
 */
#ifndef FORMULA_UTILS_FORMULA_UTILS_H
#define FORMULA_UTILS_FORMULA_UTILS_H
 ...
 */
bool mgos_formula_utils_init(void);
...
#endif //FORMULA_UTILS_FORMULA_UTILS_H
